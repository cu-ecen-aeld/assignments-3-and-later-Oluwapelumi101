...
find $TOOLCHAIN -name "libc.so.6" -exec cp {} ${OUTDIR}/rootfs/lib64/ \;

# TODO: Make device nodes
sudo mknod ${OUTDIR}/rootfs/dev/null -m 0666 c 1 3
sudo mknod ${OUTDIR}/rootfs/dev/console -m 0666 c 5 1
